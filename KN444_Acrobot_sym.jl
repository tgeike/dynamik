...
begin 
	x1 = s1*sin(ϕ1)
	y1 = s1*cos(ϕ1)
	x2 = d1*sin(ϕ1) + s2*sin(ϕ1+ϕ2)
	y2 = d1*cos(ϕ1) + s2*cos(ϕ1+ϕ2)
end;
...
# ╔═╡ ce180244-dc68-4ce6-bb93-541470a27ec0
JS1 = J1 - m1*s1^2;

# ╔═╡ 1b80326b-b065-48e3-bf87-546f9679be88
JS2 = J2 - m2*s2^2;

# ╔═╡ 16e23bc3-1443-4f71-ba2c-454d4e517db9
Z = m1/2*(a1x)^2 + m1/2*(a1y - g)^2 + 1/(2*JS1)*(JS1*α1 + M)^2 + m2/2*(a2x)^2 + m2/2*(a2y - g)^2 + 1/(2*JS2)*(JS2*(α1+α2) - M)^2;
...
write("ausgabe-acrobot.tex", latexify(dgl1), latexify(dgl2));

# ╔═╡ a51fa8be-0491-4532-b20e-c4131e336fbf
substitute(dgl1,([α1=>0,α2=>0,ω1=>0,ω2=>0]))

# ╔═╡ 00744ff9-59d2-43de-82bd-93813d017e13
md"""
#### Alternativ Herleitung über die Gibbs-Appell-Gleichungen"""

# ╔═╡ 09125a3c-fe18-4d86-bba9-d198911dafc6
md"""*folgt später*"""
