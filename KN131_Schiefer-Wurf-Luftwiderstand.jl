...
# ╔═╡ 76ee5178-71c0-41e9-b1d3-99d678e76615
md"""Wurfdauer, Wurfweite, maximale Flughöhe etc. bestimmen"""

# ╔═╡ 02ab022d-c64b-4d6d-930b-f8e04d639b4f
begin
	t_Wurf = maximum(sol1.t)
	@printf("Dauer des Wurfs: %.2f s",t_Wurf)
end

# ╔═╡ 0e1f0dfb-ef1e-4440-abab-48123fd3a856
x_Wurf = maximum(sol1[1,:])
...
manifest_format = "2.0"
project_hash = "2c2faa89806fa429cabb58898c042258206a4d73"
